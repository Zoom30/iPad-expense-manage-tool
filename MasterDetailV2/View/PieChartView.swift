...
class PieChartView: UIView {
    ...
    //labels are not included in the actual view, but they can be configured and set to be included here
    ...
    func percentToRadian(_ percent: CGFloat) -> CGFloat {
        //since angle counting starts wtih X positive axis, 270 degrees are added to rotate the starting point to Y positive axis.
    ...
    func addSlice(_ slice: Slice) {
        ...
        sliceLayer.lineWidth = canvasWidth * 1 / 4
